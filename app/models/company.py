# DOMAIN: BACKEND
# LAST_MODIFIED: 2026-01-27 16:50:00
import uuid
...
class Company(Base):
    ...
    # --- 2. SEGURANÇA E KIOSK (L7) ---
    kiosk_password_hash = Column(String(255), nullable=True)

    # --- 3. STATUS SAAS E SEGMENTAÇÃO ---
