...
import uuid
from sqlalchemy import Column, String, Integer, Boolean, DateTime, ForeignKey, Numeric, Text, Index
from sqlalchemy.sql import func
from sqlalchemy.orm import relationship
from app.database import Base
from app.models.core import GUID, OrderStatus, PaymentMethod, PaymentStatus, OrderType, OrderOrigin, ServiceType
...
class ServiceRequest(Base):
    ...
    service_type = Column(String(50), nullable=False) # Enum as String
