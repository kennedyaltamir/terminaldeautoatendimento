          ...
          {filteredProducts.map(product => (
            ...
            >
              ...
              <div className="flex justify-between items-end mt-2">
                <span className="font-mono font-bold text-orange-500 text-sm">R$ {Number(product.price).toFixed(2)}</span>
              ...
              <div key={idx} className="bg-gray-700/50 p-2 rounded border border-gray-700 flex justify-between items-center group">
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between">
                    ...
                    <p className="text-xs text-gray-400 font-mono">R$ {Number(item.product.price).toFixed(2)}</p>
                  </div>
