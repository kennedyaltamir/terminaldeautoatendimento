...
import { ChefHat, RefreshCw, LogOut, ArrowRightCircle, CheckCircle2, Volume2, VolumeX, DollarSign, Printer, Bike, BellRing, XCircle, Utensils, Wine, Layers, History, Undo2, Box, AlertTriangle, IceCream, Smartphone, ListChecks } from "lucide-react";
...
import ItemAggregator from "@/components/admin/KDS/ItemAggregator"; // NOVO
...
export default function KitchenPage({ params }: { params: { slug: string } }) {
  ...
  const [isAggregatorOpen, setIsAggregatorOpen] = useState(false); // NOVO
      ...
      <div className="print:hidden">
        <header className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-6 border-b border-gray-800 pb-4 gap-4">
            ...
            <div className="flex gap-2">
                <button onClick={() => setIsAggregatorOpen(true)} className="p-3 bg-gray-800 rounded-xl hover:bg-gray-700 transition-all text-green-400 border border-gray-700" title="Resumo de Produção"><ListChecks size={20} /></button>
