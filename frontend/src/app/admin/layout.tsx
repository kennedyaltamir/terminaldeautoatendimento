...
export default function AdminLayout({
  ...
  const allNavItems = [
    ...
    { name: "Franquia", href: `/admin/franchise`, icon: Building2, id: "nav-franchise", roles: ['owner'] }, // NOVO
  ...
  const isFranchiseMode = pathname.includes("/franchise"); // Novo modo fullscreen
