...
import { FileText, Save, Loader2, AlertTriangle, Info, ShieldCheck, Search, CheckCircle2, ExternalLink } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-gray-900 border rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all ${errors.inscricao_estadual ? 'border-red-500' : 'border-gray-600'}`}
                placeholder="Isento ou Número"
              />
              {errors.inscricao_estadual && <p className="text-red-400 text-xs mt-1">{errors.inscricao_estadual.message}</p>}
            ...
            <div>
              ...
              <div className="relative">
                <input
                    ...
                    type="password"
                    className={`w-full bg-gray-900 border rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all font-mono text-sm pr-24 ${errors.fiscal_token ? 'border-red-500' : 'border-gray-600'}`}
              ...
              {errors.fiscal_token && <p className="text-red-400 text-xs mt-1">{errors.fiscal_token.message}</p>}
            </div>
