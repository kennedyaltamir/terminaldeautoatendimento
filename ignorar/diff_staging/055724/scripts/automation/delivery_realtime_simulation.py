...
# ==============================================================================
# 🛵 REAL-TIME DELIVERY & GPS SIMULATION (L6.9 - OMNI EXPERIENCE)
# ==============================================================================
...
async def run_simulation():
    ...
    async with async_playwright() as p:
        ...
        await customer_page.fill("textarea", "Simulação L6.9: Sincronia total.")
        ...
        # O texto deve mudar para "Em Rota" via WebSocket
