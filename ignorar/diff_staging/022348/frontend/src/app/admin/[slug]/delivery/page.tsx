# DOMAIN: FRONTEND
# LAST_MODIFIED: 2026-01-15 02:30:15
"use client";
                ...
                <div className="flex gap-2">
                  {order.status === 'ready' ? (
                    ...
                    <button 
                      ...
                      className="flex-1 bg-emerald-600 text-white py-4 rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-900/20 active:scale-95 flex items-center justify-center gap-2"
                    >
                    ...
                    <button 
                      type="button"
                      disabled
                      onClick={() => toast.info("Este pedido ainda está sendo preparado pela cozinha.")}
                      className="flex-1 bg-slate-200 dark:bg-slate-800 text-slate-400 dark:text-slate-600 py-4 rounded-2xl font-black uppercase text-xs tracking-widest cursor-not-allowed flex items-center justify-center gap-2"
                    >
