...
export default function FiscalSection({ company }: FiscalSectionProps) {
  ...
  const {
    ...
    defaultValues: {
      name: company.name, // Obrigatório pelo schema
      cnpj: company.cnpj || "",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                {...register("cnpj")}
                className={`w-full bg-gray-900 border rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all ${errors.cnpj ? 'border-red-500' : 'border-gray-600'}`}
