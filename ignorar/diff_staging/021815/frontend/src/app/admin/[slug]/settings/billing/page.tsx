...
import { 
  ...
  AlertCircle, HelpCircle, CreditCard, History 
} from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-8 items-stretch">
        ...
        <div className={cn(
          ...
          <button 
            type="button"
            disabled 
            className="w-full py-4 rounded-2xl border-2 border-slate-700 text-slate-500 font-black uppercase tracking-widest text-xs cursor-not-allowed"
          >
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 px-8 py-6 bg-slate-900/50 rounded-3xl border border-slate-800">
        ...
        <button type="button" className="text-[10px] font-black text-orange-500 uppercase tracking-widest hover:underline flex items-center gap-2">
