              ...
              {loading ? (
                ...
                orders.map((order) => (
                  <tr key={order.id} className="hover:bg-gray-700/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <button type="button" onClick={() => setSelectedOrder(order)} className="p-2 bg-gray-700 hover:bg-gray-600 rounded-lg text-white transition-colors">
                        <Eye size={16} />
                      </button>
                    </td>
                  </tr>
        ...
        {selectedOrder && (
          <div className="space-y-4 text-gray-300">
            ...
            <div className="flex justify-end pt-4">
              <button type="button" onClick={() => setSelectedOrder(null)} className="bg-gray-700 text-white px-4 py-2 rounded-lg font-bold">Fechar</button>
            </div>
          </div>
        )}
      </Modal>
