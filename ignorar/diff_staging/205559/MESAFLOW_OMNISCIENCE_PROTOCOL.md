...
- **`protocols/`:** Regras de conversação, rollback e segurança.
...
---
**ESTADO ATUAL:** O sistema está em fase de **Estabilização Absoluta**. O foco é a criação do **Omni-Check** para garantir que 100% dos scripts de validação passem simultaneamente.
