...
from app.models import Company, Order, OrderItem, Product, Table, TableSession, OrderStatus, PaymentStatus, OrderType, OrderOrigin
...
def get_order_public(order_id: uuid.UUID, db: Session = Depends(get_db)):
    ...
    """
    # 🛡️ SEGURANÇA: Desativa RLS para encontrar o pedido e identificar o dono (Tenant)
    # Necessário pois o cliente não possui token JWT com company_id neste estágio.
