...
# ==============================================================================
# 🛵 REAL-TIME DELIVERY & GPS SIMULATION (L6.12 - STABLE EDITION)
# ==============================================================================
...
async def run_simulation():
    ...
    async with async_playwright() as p:
        ...
        # Aguarda o carregamento da página (que agora compila sem erro de sintaxe)
        ...
        await customer_page.fill("textarea", "Simulação L6.12: Build e Rota Estáveis.")
        ...
        # Simula movimento GPS fluido (10 pontos)
        print("📍 Iniciando percurso simulado...")
        start_lat, start_lng = -23.5614, -46.6559
        end_lat, end_lng = -23.5667, -46.6512
