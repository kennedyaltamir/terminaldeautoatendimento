...
// Coordenadas de referência para Pompéu, MG (Base Operacional)
...
export default function DriverPage({ params }: { params: { slug: string } }) {
  ...
  // Monitoramento de Geolocalização Nativa
  useEffect(() => {
    if (activeDelivery && typeof navigator !== "undefined" && "geolocation" in navigator) {
      watchId.current = navigator.geolocation.watchPosition(
        (pos) => {
          ...
          // Propaga localização para o backend/cliente
        ...
        () => toast.error("Permissão de GPS necessária para entregas"),
