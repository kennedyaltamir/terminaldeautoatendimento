...
# LAST_MODIFIED: 2026-01-15 15:35:00
import asyncio
import json
import sys
import os
...
async def run_l8_simulation():
    ...
    with SimulationTransaction(API_URL, SLUG, token) as tx:
        async with async_playwright() as p:
            ...
            # 3. BROWSER SETUP (Com Permissões Automáticas)
