...
class WhatsAppService:
    """Serviço de WhatsApp Resiliente (SRE Hardened)."""
    def __init__(self):
    ...
    def _get_config(self, company_settings: Any) -> Dict[str, Any]:
        ...
        return {"url": api_url, "token": token, "instance": instance, "enabled": bool(api_url and token and instance)}
    ...
    async def _send_http_request(self, phone: str, message: str, config: Dict[str, Any]):
        ...
        async with httpx.AsyncClient(timeout=self.timeout) as client:
            try:
                ...
                logger.warning(f"WhatsApp Offline: {e}")
                return False
