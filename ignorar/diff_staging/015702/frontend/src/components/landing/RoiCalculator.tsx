...
import { DollarSign, Users, Utensils, ArrowRight } from "lucide-react";
        ...
        <div className="bg-gray-900 dark:bg-gray-800 rounded-3xl p-8 md:p-12 text-white shadow-2xl overflow-hidden relative">
          ...
          <div className="grid md:grid-cols-2 gap-12 relative z-10">
              ...
              <div className="space-y-6">
                <div>
                  <label className="flex justify-between text-sm font-medium mb-2">
                    ...
                    <span className="text-orange-400 font-bold">{orders}</span>
                  </label>
                ...
                <div>
                  <label className="flex justify-between text-sm font-medium mb-2">
                    ...
                    <span className="text-orange-400 font-bold">R$ {ticket}</span>
                  </label>
                ...
                <div>
                  <label className="flex justify-between text-sm font-medium mb-2">
                    ...
                    <span className="text-orange-400 font-bold">{staff} pessoas</span>
                  </label>
            ...
            <div className="flex flex-col justify-center items-center bg-white/5 rounded-2xl p-8 border border-white/10 backdrop-blur-sm">
              ...
              <Link 
                href="/admin/register"
                className="mt-8 bg-white text-gray-900 px-8 py-4 rounded-xl font-black hover:bg-orange-50 transition-all w-full text-center flex items-center justify-center gap-2 group"
              >
