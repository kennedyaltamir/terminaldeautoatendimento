...
export default function LeadCapture() {
  ...
  // Simula a exibição após 5 segundos
  useState(() => {
            ...
            {sent ? (
              ...
              <>
                <h3 className="text-xl font-black text-slate-900 dark:text-white leading-tight mb-2">
                  Dicas de Gestão <span className="text-orange-600">Grátis</span>.
                </h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
                  Receba semanalmente estratégias para aumentar o faturamento do seu restaurante.
                </p>
