...
# LAST_MODIFIED: 2026-01-15 18:15:00
import subprocess
import socket
import sys
import os
...
# ==============================================================================
# 🏁 MESAFLOW TEST ORCHESTRATOR v1.3 (Self-Healing & Hardened)
# ==============================================================================
...
def check_qa_readiness():
    """Verifica se o ambiente de QA está íntegro."""
    playwright_path = Path("frontend/node_modules/@playwright/test")
    if not playwright_path.exists():
        print("🚨 ERRO: Dependências do Playwright não encontradas.")
        print("👉 EXECUTE: python scripts/setup/bootstrap_qa.py")
        return False
    return True
...
def main():
    print("====================================================")
    print("🛡️  MESAFLOW OMNI-TESTER v1.3")
    print("====================================================")
    ...
    if k6_check.returncode == 0:
        ...
        results.append({"name": "Carga/Realtime", "status": "⏭️ SKIPPED", "duration": "0s", "output": "k6 not found", "error": ""})
    ...
    print(f"✅ Relatório finalizado em: {REPORT_PATH}")
