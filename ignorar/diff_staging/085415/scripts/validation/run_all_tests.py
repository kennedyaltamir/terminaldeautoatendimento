...
# LAST_MODIFIED: 2026-01-15 18:00:00
import subprocess
import socket
import sys
import os
...
# ==============================================================================
# 🏁 MESAFLOW TEST ORCHESTRATOR v1.2 (Strict Path Resolution)
# ==============================================================================
...
def main():
    print("====================================================")
    print("🛡️  MESAFLOW OMNI-TESTER v1.2")
    print("====================================================")
    ...
    # Fix: npx playwright test sem argumentos para deixar o config gerenciar os caminhos resolvidos por path.resolve()
