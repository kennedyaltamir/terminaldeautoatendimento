import { ChefHat, Instagram, Linkedin, Twitter, Globe, ShieldCheck, Activity } from "lucide-react";
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-[2rem] space-y-4">
              ...
              <div className="flex gap-2">
                <input 
                  ...
                  className="flex-1 bg-slate-950 border border-slate-800 rounded-xl px-4 py-2 text-xs outline-none focus:border-orange-500 transition-colors"
                />
                <button className="bg-white text-slate-950 p-2 rounded-xl hover:bg-orange-500 hover:text-white transition-all">
                  <ArrowRight size={18} />
                </button>
              </div>
            </div>
