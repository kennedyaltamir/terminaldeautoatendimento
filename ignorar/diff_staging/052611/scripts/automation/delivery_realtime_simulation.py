...
# ==============================================================================
# 🛵 REAL-TIME DELIVERY & TRACKING SIMULATION (L6.2 - Full Flow)
# ==============================================================================
# Objetivo: Simular a sincronia entre o Entregador e o Cliente Final.
# Fix v6.2: Confirmação de pagamento via API para habilitar stepper no cliente.
# ==============================================================================
...
async def setup_order():
    ...
    # 1. Marca como PAGO (Necessário para o stepper aparecer no cliente)
    requests.patch(f"{API_URL}/admin/orders/{order_id}/payment", headers=headers, json={"payment_status": "paid"})
    
    # 2. Move para READY (Pronto para Retirada)
...
async def run_simulation():
    ...
    async with async_playwright() as p:
        ...
        try:
            # Agora o stepper deve estar visível pois o pedido está PAGO
