# 📱 AdminCallbackPage
> **Plataforma:** Web
> **Rota/Arquivo:** `/admin/payment/callback`
...
![Screenshot](../placeholders/admincallbackpage_screenshot.png)

## 3. Estrutura Técnica
**Arquivo Fonte:** `frontend\src\app\admin\payment\callback\page.tsx`
