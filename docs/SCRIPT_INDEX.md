...
| Script | Tipo | Descrição |
| :--- | :---: | :--- |
| [run_mobile_ci.bat](../scripts/run_mobile_ci.bat) | 🐚 | 1. UI Sweep (Visual Validation) |
| [run_mobile_dev.bat](../scripts/run_mobile_dev.bat) | 🐚 | 1. Executar Auditoria |
| [run_mobile_dev.sh](../scripts/run_mobile_dev.sh) | 🐚 | !/bin/bash |

## 📂 `scripts/audit`
| Script | Tipo | Descrição |
| :--- | :---: | :--- |
| [list_all_interactive_elements.py](../scripts/audit/list_all_interactive_elements.py) | 🐍 | 🕵️ INTERACTIVE ELEMENT LISTER (Deep Scan) |
| [list_frontend_pages.py](../scripts/audit/list_frontend_pages.py) | 🐍 | 🗺️ FRONTEND PAGE MAPPER |
...
| Script | Tipo | Descrição |
| :--- | :---: | :--- |
| [bkp_02_snapshot_integrity.py](../scripts/governance/bkp_02_snapshot_integrity.py) | 🐍 | Verifica se os zips em backups/ são válidos |
| [gov_01_xml_presence_audit.py](../scripts/governance/gov_01_xml_presence_audit.py) | 🐍 | 🏛️ GOVERNANCE XML PRESENCE AUDIT (GOV-01) |
| [gov_02_header_audit.py](../scripts/governance/gov_02_header_audit.py) | 🐍 | GOV-02: Mandatory Header Audit (v2.1 - High Performance). |
| [gov_03_schema_validation.py](../scripts/governance/gov_03_schema_validation.py) | 🐍 | 🏛️ GOVERNANCE XML SCHEMA VALIDATION (GOV-03) |
| [gov_04_registry_drift.py](../scripts/governance/gov_04_registry_drift.py) | 🐍 | Windows Resilience |
| [inf_01_healthcheck.py](../scripts/governance/inf_01_healthcheck.py) | 🐍 | Script de automação. |
| [inv_01_zero_config.py](../scripts/governance/inv_01_zero_config.py) | 🐍 | Verifica se o sistema sobe apenas com o .env |
| [inv_02_readiness_summary.py](../scripts/governance/inv_02_readiness_summary.py) | 🐍 | Consolida status do registry.xml |
| [inv_03_auditor_simulation.py](../scripts/governance/inv_03_auditor_simulation.py) | 🐍 | Roda checks de segurança e conformidade |
| [run_doc_protocol.py](../scripts/governance/run_doc_protocol.py) | 🐍 | 📚 MESAFLOW DOCUMENTATION PROTOCOL ORCHESTRATOR |
| [system_integrity_check.py](../scripts/governance/system_integrity_check.py) | 🐍 | Script de automação. |
...
| [audit_mobile_l4.py](../scripts/maintenance/audit_mobile_l4.py) | 🐍 | Script de automação. |
| [audit_mobile_production.py](../scripts/maintenance/audit_mobile_production.py) | 🐍 | Script de automação. |
...
| [backup_diff_audit.py](../scripts/maintenance/backup_diff_audit.py) | 🐍 | Compara os dois últimos snapshots |
...
| [prepare_handoff.py](../scripts/maintenance/prepare_handoff.py) | 🐍 | Script de automação. |
| [production_absolute_audit.py](../scripts/maintenance/production_absolute_audit.py) | 🐍 | Script de automação. |
| [production_lock_mobile.py](../scripts/maintenance/production_lock_mobile.py) | 🐍 | Script de automação. |
...
| [sanitize_knowledge_base.py](../scripts/maintenance/sanitize_knowledge_base.py) | 🐍 | Script de automação. |
...
| [verify_screen_resilience.py](../scripts/maintenance/verify_screen_resilience.py) | 🐍 | Script de automação. |
| [verify_telemetry.py](../scripts/maintenance/verify_telemetry.py) | 🐍 | Script de automação. |
...
| Script | Tipo | Descrição |
| :--- | :---: | :--- |
| [expo_runtime_probe.py](../scripts/mobile/expo_runtime_probe.py) | 🐍 | INF-04: Expo Runtime Probe. |

## 📂 `scripts/observability`
| Script | Tipo | Descrição |
| :--- | :---: | :--- |
| [obs_02_log_structure.py](../scripts/observability/obs_02_log_structure.py) | 🐍 | Verifica se o logger.py está gerando JSON válido |
| [obs_03_correlation_id.py](../scripts/observability/obs_03_correlation_id.py) | 🐍 | Verifica se requests possuem IDs rastreáveis |
| [render_health_probe.py](../scripts/observability/render_health_probe.py) | 🐍 | INF-02: Render Health Probe. |
| [sentry_ingest_test.py](../scripts/observability/sentry_ingest_test.py) | 🐍 | OBS-01: Sentry Ingest Test. |
| [vercel_latency_check.py](../scripts/observability/vercel_latency_check.py) | 🐍 | INF-03: Vercel to Backend Latency Check. |
...
| [sec_01A_rls_policy_inventory.py](../scripts/security/sec_01A_rls_policy_inventory.py) | 🐍 | SEC-01A: Auditoria de Existência e Força de Políticas RLS. |
| [sec_01B_rls_role_matrix.py](../scripts/security/sec_01B_rls_role_matrix.py) | 🐍 | SEC-01B: Auditoria de Roles e Privilégios. |
| [sec_01C_rls_effective_context.py](../scripts/security/sec_01C_rls_effective_context.py) | 🐍 | SEC-01C: Validação de Propagação de Contexto. |
| [sec_01D_rls_readonly_probe.py](../scripts/security/sec_01D_rls_readonly_probe.py) | 🐍 | SEC-01D: Prova de Conceito de Filtro RLS via EXPLAIN. |
| [sec_01_rls_integrity.py](../scripts/security/sec_01_rls_integrity.py) | 🐍 | SEC-01: Validador de RLS Hardened v2. |
| [sec_04_env_audit.py](../scripts/security/sec_04_env_audit.py) | 🐍 | SEC-04: Secrets & Env Audit. |
| [sec_05_boundary_audit.py](../scripts/security/sec_05_boundary_audit.py) | 🐍 | 🛡️ SECURITY BOUNDARY AUDIT (SEC-05) |
| [stress_test_guards.py](../scripts/security/stress_test_guards.py) | 🐍 | Script de automação. |
...
| [app_04_error_handling.py](../scripts/validation/app_04_error_handling.py) | 🐍 | Verifica se middlewares de erro estão ativos |
| [check_db_fiscal_config.py](../scripts/validation/check_db_fiscal_config.py) | 🐍 | Windows Resilience |
