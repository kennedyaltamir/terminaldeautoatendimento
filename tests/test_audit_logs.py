...
def test_audit_log_lifecycle():
    ...
    assert log_db.details["old"]["price"] == 10.0
    assert log_db.details["new"]["price"] == 20.0
    db.close()
    ...
    # Deve encontrar pelo menos 1 log (o que acabamos de criar)
    # Filtramos pelo ID do recurso para garantir que é o nosso
